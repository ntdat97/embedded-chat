      ...
      <div className='p-6 pt-5 border-b overflow-y-auto pb-[68px]' style={{
        ...
        <div className={cn(rowClass)}>
          ...
          <div className='grow'>
            ...
            />
            <a className='mt-2 flex items-center h-[18px] px-3 text-xs text-gray-500' href="https://docs.Lexi.ai/advanced/datasets#how-to-write-a-good-dataset-description" target='_blank'>
          ...
          <div className={labelClass}>
            <div>
              ...
              <div className='leading-[18px] text-xs font-normal text-gray-500'>
                <a target='_blank' href='https://docs.Lexi.ai/advanced/retrieval-augment' className='text-[#155eef]'>{t('datasetSettings.form.retrievalSetting.learnMore')}</a>
