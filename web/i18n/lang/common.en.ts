const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Lexi account',
    langGeniusAccountTip: 'Your Lexi account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Lexi to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Lexi allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API-based extensions provide centralized API management, simplifying configuration for easy use across Lexi\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.Lexi.ai/advanced/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'Lexi {{version}} is now available.',
    latestAvailable: 'Lexi {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
