const translation = {
  ...
  welcome: 'Welcome to Lexi, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Lexi Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Lexi',
  invalid: 'The link has expired',
  explore: 'Explore Lexi',
