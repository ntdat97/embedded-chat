...
async function embedChatbot () {
  ...
  function createIframe () {
    ...
    iframe.title = "Lexi chatbot bubble window"
    iframe.id = 'dify-chatbot-bubble-window'
    iframe.src = `${baseUrl}/chatbot/${difyChatbotConfig.token}`
    iframe.style.cssText = 'border: none; position: fixed; flex-direction: column; justify-content: space-between; box-shadow: rgba(150, 150, 150, 0.2) 0px 10px 30px 0px, rgba(150, 150, 150, 0.2) 0px 0px 0px 1px; bottom: 5rem; right: 1rem; width: 24rem; max-width: calc(100vw - 2rem); height: 44rem; max-height: calc(100vh - 6rem);border-radius: 0.75rem; display: flex; z-index: 2147483647; overflow: hidden; left: unset; background-color: #F3F4F6;'
